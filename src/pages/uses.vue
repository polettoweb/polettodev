  ...
  <Layout>
    <div class="container-inner mx-auto py-16">
      ...
      <div>
        ...
        <ul>
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>Mac Mini 2018</strong> (3.2 GHz i7, 16 GB 2667 MHz, 512GB, AMD 5700 XT via Thunderbolt 3)
          </li>
          <li class="text-copy-secondary ml-4 mb-4">
          ...
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>AORUS AD27QD</strong> 1440p monitor
          </li>
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>iPad pro 12.9"</strong> (256GB space grey)
          </li>
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>Pixel 2 XL</strong>
          </li>
        </ul>
        <h2 class="text-2xl font-bold">Development Tools</h2>
        <ul>
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>VS Code</strong> with
            <strong>Monokai PRO</strong> theme and
            <strong>Dank Mono</strong> as font
          </li>
          <li class="text-copy-secondary ml-4 mb-4">
        ...
        <ul>
          <li class="text-copy-secondary ml-4 mb-4">
            <strong>Notability</strong> for notes taking
          </li>
          <li class="text-copy-secondary ml-4 mb-4">
        ...
        <h2 class="text-2xl font-bold">Other stuff</h2>
        <ul>
          <li class="text-copy-secondary ml-4 mb-4">
